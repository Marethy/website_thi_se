...
namespace WebApplicationThucHanh2.Areas.Admin.Controllers
{
    ...
    public class TDanhMucSpsController : Controller
    {
        ...
        public TDanhMucSpsController(QLBanVaLiDbContext context)
        {
            _context = context;
        }

        // GET: Admin/TDanhMucSps
        public async Task<IActionResult> Index()
        {
            var qLBanVaLiDbContext = _context.TDanhMucSps.Include(t => t.MaChatLieuNavigation).Include(t => t.MaDtNavigation).Include(t => t.MaHangSxNavigation).Include(t => t.MaLoaiNavigation).Include(t => t.MaNuocSxNavigation);
            return View(await qLBanVaLiDbContext.ToListAsync());
        }

        // GET: Admin/TDanhMucSps/Details/5
        ...
        // GET: Admin/TDanhMucSps/Delete/5
        ...
        // POST: Admin/TDanhMucSps/Delete/5
